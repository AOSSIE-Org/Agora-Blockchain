		...
		return (
			<div>
				<div className="status">
					<div className="statusIndicator" style={{backgroundColor: COLORS[status]}}></div>
					<font>{text}</font>
				</div>
			</div>
		)
		...
		return (
			<tr>
				...
				<td className="tableDetails">
					...
					<font className="text-muted" size="1">{electionAddress}</font>
				</td>
				<td>{startDate}</td>
				<td>{endDate}</td>
				<td>
					<Status status={status} text={status.charAt(0).toUpperCase() + status.slice(1)}/>
				</td>
			</tr>
		)
	}
			...
			<div style={{margin: "30px"}}>
				<div style={{width: "100%"}}>
					<div style={{float: "left"}}>
						...
						<font size="2" className="text-muted">Agora Blockchain</font>
					</div>
				...
				<div className="cardContainer row">
					<CardItem headerValue="4" descriptor="Total elections" imgUrl="/assets/totalElections.png"/>

					<CardItem headerValue="2" descriptor="Active elections" imgUrl="/assets/activeElections.png" imgBackground="#eaffe8"/>

					<CardItem headerValue="1" descriptor="Closed elections" imgUrl="/assets/endedElections.png" imgBackground="#ffe8e8"/>
				...
				<div className="dashboardBody row">
					...
					<div className="rhsDashboard">
						...
						<div className="networkHeader">
							<div className="imageHolder shadow" style={{backgroundColor: "#f7f7f7"}}>
								<div className="centered">
									<img src="/assets/ethereum.png" className="image" alt="profile-pic"/>
								</div>
							</div>
						...
						<font size="2" className="text-muted">0x9505...c8E49</font>

						<div style={{display: "flex", height: "190px", flexDirection: "row", alignItems: "flex-end"}}>
