...
const ElectionMiniSkeleton: React.FC = () => {
  return (
    <div className="bg-white p-6 rounded-lg shadow-md animate-pulse w-full dark:bg-dark">
      ...
      <div className="h-4 bg-gray-200 rounded w-5/6 mb-4 dark:bg-gray-700"></div>
      <div className="h-8 bg-gray-200 rounded w-1/4 mt-6 dark:bg-gray-700"></div>
    </div>
  );
};
...
const ProfilePage: React.FC = () => {
  ...
  if (isLoading) {
    return (
      <div className="min-h-screen w-full flex items-center justify-center dark:bg-dark">
        <Loader />
      </div>
    );
  }
  ...
  return (
    <div className="min-h-screen w-full bg-gradient-to-br from-gray-100 to-gray-200 pt-20 flex items-start justify-center dark:bg-dark">
      <div className="w-full max-w-4xl p-6 bg-white rounded-3xl shadow-xl dark:bg-gray-800">
