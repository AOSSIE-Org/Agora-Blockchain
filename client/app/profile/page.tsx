...
const ElectionMiniSkeleton: React.FC = () => {
  return (
    <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-md animate-pulse w-full">
      ...
      <div className="h-8 bg-gray-200 dark:bg-gray-700 rounded w-1/4 mt-6"></div>
    </div>
  );
};
...
const ProfilePage: React.FC = () => {
  ...
  return (
    <div className="min-h-screen w-full bg-gradient-to-br from-gray-100 to-gray-200 dark:from-gray-800 dark:to-gray-900 pt-20 flex items-start justify-center">
      <div className="w-full max-w-4xl p-6 bg-white dark:bg-gray-800 rounded-3xl shadow-xl">
